...
tof_cell9_2 = zeros(200,100,25,6);
frq = 500e3;
kk = 14;
for ii = 6:10
    ...
    tof_cell9_2(:,:,ii,5) = tof_data;
end

save('I:\backup\data\kwave\result\2018_09_28_realisticScatter_variousIMCL/tof_cell9_2','tof_cell9_2');